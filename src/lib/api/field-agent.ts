...
export const fieldAgentApi = {
  ...
  createTestType: (data: { name: string; allowedResults: string[] }) =>
    fieldAgentRequest('/fieldAgent/testtypes', { method: 'POST', body: JSON.stringify(data) }),
  updateTestType: (id: string, data: { name: string; allowedResults: string[] }) =>
    fieldAgentRequest(`/fieldAgent/testtypes/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
  deleteTestType: (id: string) =>
    fieldAgentRequest(`/fieldAgent/testtypes/${id}`, { method: 'DELETE' }),
