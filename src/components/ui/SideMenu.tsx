  ...
  return (
    <>
      ...
      <div className="lg:hidden">
        ...
        <aside 
          className={`fixed left-0 top-0 h-screen w-72 sm:w-80 bg-white flex flex-col z-40 transform transition-transform duration-300 ease-in-out overflow-y-auto ${
