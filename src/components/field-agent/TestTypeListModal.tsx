...
interface TestTypeListModalProps {
  ...
  onCreateNew?: () => void;
  isReadOnly?: boolean; // Field agents only view test types, no edit/delete/create
}
...
const TestTypeListModal: React.FC<TestTypeListModalProps> = ({
  ...
  onEdit,
  onDelete,
  isReadOnly = true, // Default to read-only for field agents
}) => {
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    {/* Edit and Delete buttons only shown when not in read-only mode */}
                    {!isReadOnly && onEdit && (
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
            ...
            {testTypes.length === 0 && (
              <div className="text-center py-8">
                ...
                <p className="font-poppins text-sm text-[#9da9b4] mt-1">
                  No test types available at this time
                </p>
              </div>
            )}
          </div>
