...
export default function TestsStatCard({ 
  ...
  return (
    <div className="bg-[#fbeaea] rounded-[10px] px-5 py-3 inline-flex flex-col gap-4">
      {/* Title */}
      ...
      <div className="flex items-center gap-[88px]">
        ...
        <div className="flex flex-col w-[261px]">
          <p className="font-poppins font-semibold text-[32px] text-[#212b36]">
        ...
        {/* Icon */}
        <div className="w-[45px] h-[45px] bg-white rounded-full flex items-center justify-center overflow-hidden">
