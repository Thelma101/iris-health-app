 ...
 */
export const createVisitation =asyncHandler(async (req: Request, res: Response): Promise<void> => {
  const {
    patientId,
    communityId,
    visitDate,
 ...
 * Get all visitations
 */
export const getAllVisitations =asyncHandler(async (req: Request, res: Response): Promise<void> =>  {
 ...
 */
export const getVisitationsByPatient =asyncHandler(async (req: Request, res: Response): Promise<void> =>  {
 ...
 */
export const getVisitationsByCommunity = asyncHandler(async (req: Request, res: Response): Promise<void> =>  {
 ...
 * Delete visitation
 */
export const deleteVisitation = asyncHandler(
